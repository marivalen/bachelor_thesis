...
Interactions between MHC class I heavy chains and beta2-microglobulin ($\beta_{2}$m) play a critical role in the stability of MHC class I on the cell surface. In this study Molecular Dynamics (MD) simulations were used to investigate the impact that $\beta_{2}$m has on the structure of MHC class I for \db and \kb, in a peptide bound and a peptide unbound state. Molecular dynamics (MD)
...
\begin{table}[H]
\caption{\textbf{Overview of the eight simulation conditions used for analysis of $\beta_{2}m$ affinity to the heavy chain.} Each of the simulations is displaying either the allotype \db or \kb, it is involved in the complex with peptide (w) or without peptide (wo) and, has the initial velocities of $v0$ or $v1$.}
\label{simulations}
\centering 
...
\begin{table}[H]
\caption{\textbf{The interacting residues used for the analysis of \kb and the percentage of their interactions below four {\AA}ngstroms. } The percentage of intractions below four {\AA}ngstroms between the residues selected in $\beta_{2}$m and the peptide binding domain of \kb in the conditions of with peptide (w) and without peptide (wo) is listed.}
\label{KBinteractions}
\centering 
\resizebox{\linewidth}{!} {
\begin{tabular}{|c|c|c|c|}  \hline
Residue (peptide binding domain) &Residue ($\beta_{2}$m)&\kb{\_}w[\%]&\kb{\_}wo[\%]\\ \hline
119&31&69&69\\ \hline
119&1&98&99\\ \hline
122&60&50&43\\ \hline
96&31&99&99\\ \hline
...
\begin{table}[H]
\caption{\textbf{The interacting residues used for the analysis of \db and the percentage of their interactions below four {\AA}ngstroms. } The percentage of intractions below four {\AA}ngstroms between the residues selected in $\beta_{2}$m and the peptide binding domain of \db in the conditions of with peptide (w) and without peptide (wo) is listed.}
\label{DBinteractions}
\centering 
\resizebox{\linewidth}{!} {
\begin{tabular}{|c|c|c|c|}  \hline
Residue (peptide binding domain)&Residue ($\beta_{2}$m)&\db{\_}w[\%]&\db{\_}wo[\%]\\ \hline
14&85&82&4\\ \hline
14&34&41&19\\ \hline
122&60&16&58\\ \hline
119&31&53&21\\ \hline
...
Residue (peptide binding domain)&Residue ($\beta_{2}$m)&\kb{\_}w[\%]&\kb{\_}wo[\%]&\db{\_}w[\%]&\db{\_}wo[\%]\\ \hline
